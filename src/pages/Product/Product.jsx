...
const Product = () => {
  ...
  const editOpen = (e) => {
    ...
    setCodeEdit(new Date().getTime())
    setBrandEdit(e.brandId)
    setColorEdit(e.colorId)
  ...
  return (
    <>
                ...
                <StyledTableRow key={e.id} >
                  ...
                  <StyledTableCell align='center'>
                    <div className='gap-[20px] flex justify-center'>
                      ...
                      <EditIcon className='text-[#3fcdcf] cursor-pointer' onClick={() => {
                        editOpen(e)
                      }} />
                    </div>
                  </StyledTableCell>
      ...
      <Dialog open={edit}>
        <div className='p-[20px] flex flex-col gap-[20px]'>
          <div className='flex justify-between items-center'>
            <h1 className='font-[700]'>Edit Product</h1>
            <CloseIcon onClick={editClose} className='cursor-pointer' />
          </div>
          <form className='flex justify-center flex-wrap gap-[10px]' onSubmit={formDataEdit}>
            <TextField value={idxE} />
            ...
            <select
              className="w-[250px] border-[2px] px-[10px] hover:border-[#4286a5] border-[#d5d4d4] rounded-[5px]"
            ...
            {/* brand */}
            <select className="w-[250px]" onChange={(e) => setBrandEdit(e.target.value)}>
            ...
            {/* color */}
            <select className="w-[250px]" onChange={(e) => setColorEdit(e.target.value)}>
            ...
            <TextField className="w-[250px]" value={descriptionEdit} onChange={(e) => setDescriptionEdit(e.target.value)} label='Description*' />
            {/* subCategory */}
            <select className="w-[250px]" onChange={(e) => setSubCategoryIdEdit(e.target.value)}>
      ...
      >
        <div className='p-[20px] flex flex-col gap-[20px]'>
          <h1 className='text-[22px]'>Are you agree?</h1>
